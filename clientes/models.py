...
class Cliente(models.Model):
    ...
    def nombre_completo(self):
        """Devuelve apellidos y nombres unidos"""
        return f'{self.apellidos}, {self.nombres}'

    @property
    def esta_activo(self):
        """Verifica si el cliente está activo"""
        from config.choices import EstadoGeneral # Importante para comparar
        return self.estado == EstadoGeneral.ACTIVO

    @property
    def total_encomiendas_enviadas(self):
        """Cuenta cuántas encomiendas ha enviado este cliente"""
        # "envios_como_remitente" debe ser el related_name que pusiste en Encomienda
